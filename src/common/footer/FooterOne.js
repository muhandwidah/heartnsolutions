                        ...
                        <div className="col-xl-6 col-lg-5">
                            <div className="footer-widget border-end">
                                <div className="footer-newsletter">
                                    ...
                                    <p>Let us help you get your dream home!</p>
                                    <form>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="footer-copyright">
                                <span className="copyright-text">© {new Date().getFullYear()}. All rights reserved by <a href="https://google.com/">Heart N Solutions Management</a>.</span>
                            </div>
                        </div>
                        <div className="col-md-6">
